...
set_directive_interface -mode ap_fifo "Aurora_to_fifo_IP_fpga2_block" input_fifo
set_directive_interface -mode ap_ctrl_chain -register "Aurora_to_fifo_IP_fpga2_block"
set_directive_interface -mode ap_vld "Aurora_to_fifo_IP_fpga2_block" SequenceErrorFlag
