...
void Aurora_to_fifo_IP_fpga8_block(hls::stream< ap_uint<(32*NUMBER_OF_LANES)> > &input_fifo, hls::stream<packaging_data>& out_fifo, volatile ap_uint<1> *SequenceErrorFlag)
{
