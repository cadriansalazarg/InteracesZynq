...
exec rm -rf MatrixMultOneFPGA3PN_prj_v1/ vivado.*

# Se crea el proyecto
create_project MatrixMultOneFPGA3PN_prj_v1 MatrixMultOneFPGA3PN_prj_v1 -part xc7z045ffg900-2
...
add_files -fileset constrs_1 -norecurse constraints/pinesMatrixMult_3PNs1FPGA_v1.xdc
...
add_files -fileset sim_1 -norecurse {TestBench/MatrixGenerator_tb.v TestBench/MatrixChecker_tb.v}
...
create_bd_cell -type module -reference MatrixGenerator MatrixGenerator_0

set_property CONFIG.POLARITY ACTIVE_HIGH [get_bd_pins /MatrixGenerator_0/reset]

create_bd_cell -type module -reference MatrixChecker MatrixChecker_0
...
startgroup
make_bd_pins_external  [get_bd_pins MatrixChecker_0/Error_Counter]
endgroup
