...
# El reset del Aurora_to_fifo_1 debe invertirse, ya que el hls lo genera con la polaridad invertida
connect_bd_net [get_bd_pins Aurora_to_fifo_1/ap_rst_n] [get_bd_pins inverter_reset_TX_RX_Block/Y]
...
# El reset del Aurora_to_fifo_1 debe invertirse, ya que el hls lo genera con la polaridad invertida
connect_bd_net [get_bd_pins Aurora_to_fifo_2/ap_rst_n] [get_bd_pins inverter_reset_TX_RX_Block/Y]

connect_bd_net [get_bd_pins fifo_to_Aurora_2/empty] [get_bd_pins fifo_generator_6/empty]
connect_bd_net [get_bd_pins fifo_to_Aurora_2/dout] [get_bd_pins fifo_generator_6/dout]
connect_bd_net [get_bd_pins fifo_to_Aurora_2/rd_en] [get_bd_pins fifo_generator_6/rd_en]
...
connect_bd_net [get_bd_pins Aurora_to_fifo_2/input_r_TDATA] [get_bd_pins aurora_8b10b_2/m_axi_rx_tdata]
connect_bd_net [get_bd_pins Aurora_to_fifo_2/input_r_TLAST] [get_bd_pins aurora_8b10b_2/m_axi_rx_tlast]
connect_bd_net [get_bd_pins Aurora_to_fifo_2/input_r_TVALID] [get_bd_pins aurora_8b10b_2/m_axi_rx_tvalid]
...
# El reset del Aurora_to_fifo_1 debe invertirse, ya que el hls lo genera con la polaridad invertida
connect_bd_net [get_bd_pins Aurora_to_fifo_3/ap_rst_n] [get_bd_pins inverter_reset_TX_RX_Block/Y]

connect_bd_net [get_bd_pins fifo_to_Aurora_3/empty] [get_bd_pins fifo_generator_8/empty]
connect_bd_net [get_bd_pins fifo_to_Aurora_3/dout] [get_bd_pins fifo_generator_8/dout]
connect_bd_net [get_bd_pins fifo_to_Aurora_3/rd_en] [get_bd_pins fifo_generator_8/rd_en]
...
connect_bd_net [get_bd_pins Aurora_to_fifo_3/input_r_TDATA] [get_bd_pins aurora_8b10b_3/m_axi_rx_tdata]
connect_bd_net [get_bd_pins Aurora_to_fifo_3/input_r_TLAST] [get_bd_pins aurora_8b10b_3/m_axi_rx_tlast]
connect_bd_net [get_bd_pins Aurora_to_fifo_3/input_r_TVALID] [get_bd_pins aurora_8b10b_3/m_axi_rx_tvalid]
