...
create_bd_design "Drvrs4_PNs2_PS1_Lanes1_design"

update_compile_order -fileset sources_1
open_bd_design {project_1/project_1.srcs/sources_1/bd/Drvrs4_PNs2_PS1_Lanes1_design/Drvrs4_PNs2_PS1_Lanes1_design.bd}
...
current_bd_design [get_bd_designs Drvrs4_PNs2_PS1_Lanes1_design]
close_bd_design [get_bd_designs Drvrs4_PNs2_PS1_Lanes1_design]
...
##############################################################################################################
##############################################################################################################
############################ AQUÍ EMPIEZA LA CONSTRUCCIÓN DEL DECIMOCUARTO DISEÑO
##############################################################################################################
##############################################################################################################
##############################################################################################################
...
# En el driver 1, se conecta un Aurora 8b10b, en este caso el Aurora 8b10b 0
# En el driver 2, se conecta un Aurora 8b10b, en este caso el Aurora 8b10b 1
# En el driver 3, se conecta un acelerador de hardware el 0
# En el driver 4, se conecta un acelerador de hardware el 1



create_bd_design "Drvrs5_PNs2_PS1_Lanes2_design"

update_compile_order -fileset sources_1
open_bd_design {project_1/project_1.srcs/sources_1/bd/Drvrs5_PNs2_PS1_Lanes2_design/Drvrs5_PNs2_PS1_Lanes2_design.bd}
...
create_bd_cell -type module -reference inverter inverter_reset
...
# Se interconecta el acelerador de hardware del driver 0 y los FIFOs Generator 6 Y 7

connect_bd_net [get_bd_pins fifo_generator_7/wr_en] [get_bd_pins HardwareAccelerator_0/out_fifo_V_write]
connect_bd_net [get_bd_pins inverter_10/Y] [get_bd_pins HardwareAccelerator_0/out_fifo_V_full_n]
connect_bd_net [get_bd_pins inverter_10/A] [get_bd_pins fifo_generator_7/full]
connect_bd_net [get_bd_pins fifo_generator_7/din] [get_bd_pins HardwareAccelerator_0/out_fifo_V_din]

connect_bd_net [get_bd_pins fifo_generator_6/dout] [get_bd_pins HardwareAccelerator_0/in_fifo_V_dout]
connect_bd_net [get_bd_pins HardwareAccelerator_0/in_fifo_V_read] [get_bd_pins fifo_generator_6/rd_en]
connect_bd_net [get_bd_pins inverter_12/Y] [get_bd_pins HardwareAccelerator_0/in_fifo_V_empty_n]
connect_bd_net [get_bd_pins fifo_generator_6/empty] [get_bd_pins inverter_12/A]
...
############################### Interconexión con el acelerador de hardware Xmult1 ubicado en el driver 4 ##################
...
# Se interconecta el acelerador de hardware del driver 1 y los FIFOs Generator 8 Y 9

connect_bd_net [get_bd_pins fifo_generator_8/dout] [get_bd_pins HardwareAccelerator_1/in_fifo_V_dout]
connect_bd_net [get_bd_pins HardwareAccelerator_1/in_fifo_V_read] [get_bd_pins fifo_generator_8/rd_en]
connect_bd_net [get_bd_pins fifo_generator_8/empty] [get_bd_pins inverter_14/A]
connect_bd_net [get_bd_pins inverter_14/Y] [get_bd_pins HardwareAccelerator_1/in_fifo_V_empty_n]


connect_bd_net [get_bd_pins fifo_generator_9/din] [get_bd_pins HardwareAccelerator_1/out_fifo_V_din]
connect_bd_net [get_bd_pins HardwareAccelerator_1/out_fifo_V_write] [get_bd_pins fifo_generator_9/wr_en]
connect_bd_net [get_bd_pins fifo_generator_9/full] [get_bd_pins inverter_16/A]
connect_bd_net [get_bd_pins inverter_16/Y] [get_bd_pins HardwareAccelerator_1/out_fifo_V_full_n]
...
# Se invierte el reset para conectarlo a la unidad de empaquetamiento y desempaquetamiento
connect_bd_net [get_bd_ports peripheral_reset] [get_bd_pins inverter_reset/A]
...
current_bd_design [get_bd_designs Drvrs5_PNs2_PS1_Lanes2_design]
close_bd_design [get_bd_designs Drvrs5_PNs2_PS1_Lanes2_design]
