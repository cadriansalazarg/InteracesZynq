...
delete_bd_objs [get_bd_nets output_r_TREADY_0_1]
delete_bd_objs [get_bd_ports output_r_TREADY_0]

startgroup
delete_bd_objs [get_bd_nets unpackaging_IP_block_0_output_r_TDATA]
delete_bd_objs [get_bd_nets unpackaging_IP_block_0_output_r_TLAST]
delete_bd_objs [get_bd_nets unpackaging_IP_block_0_output_r_TVALID]
endgroup

delete_bd_objs [get_bd_ports output_r_TLAST_0] [get_bd_ports output_r_TVALID_0] [get_bd_ports output_r_TDATA_0]
...
startgroup
delete_bd_objs [get_bd_nets input_r_TVALID_0_1]
delete_bd_objs [get_bd_nets input_r_TDATA_0_1]
delete_bd_objs [get_bd_nets input_r_TLAST_0_1]
delete_bd_objs [get_bd_ports input_r_TREADY_0]

endgroup
delete_bd_objs [get_bd_ports input_r_TVALID_0] [get_bd_ports input_r_TDATA_0] [get_bd_ports input_r_TLAST_0] [get_bd_ports input_r_TREADY_0]
...
disconnect_bd_net /clk_wiz_0_clk_out3 [get_bd_ports clk_200MHz]
delete_bd_objs [get_bd_ports clk_200MHz]

startgroup
disconnect_bd_net /aurora_8b10b_0_user_clk_out [get_bd_ports user_clk]
disconnect_bd_net /clk_wiz_0_clk_out2 [get_bd_ports init_clk]
disconnect_bd_net /clk_wiz_0_clk_out1 [get_bd_ports gt_refclk]
endgroup

delete_bd_objs [get_bd_ports user_clk] [get_bd_ports gt_refclk] [get_bd_ports init_clk]

create_bd_cell -type module -reference inverter inverter_0
connect_bd_net [get_bd_ports peripheral_reset] [get_bd_pins inverter_0/A]

disconnect_bd_net /ap_rst_n_0_1 [get_bd_ports peripheral_aresetn]
delete_bd_objs [get_bd_ports peripheral_aresetn]
connect_bd_net [get_bd_pins inverter_0/Y] [get_bd_pins packaging_IP_block_0/ap_rst_n]
