...
#define NUMBER_OF_TRANSFERS	100000  // En cada transferencia se envía un arreglo con un tamaño igual a MAX_PKT_LEN elementos y se recibe estos datos, esto representa una transferencia. Este parámetro define cuantas veces se quiere ejecutar dicha transferencia
