...
exec rm -rf GapJuntionOneFPGA2PN_prj_v2/ vivado.*

# Se crea el proyecto
create_project GapJuntionOneFPGA2PN_prj_v2 GapJuntionOneFPGA2PN_prj_v2 -part xc7z045ffg900-2
...
add_files -fileset constrs_1 -norecurse constraints/pinesGapJuntion_2PNs1FPGA_v2.xdc
...
set_property -dict [list CONFIG.C_PROBE8_WIDTH {4} CONFIG.C_PROBE4_WIDTH {32} CONFIG.C_PROBE0_WIDTH {32} CONFIG.C_DATA_DEPTH {16384} CONFIG.C_NUM_OF_PROBES {14} CONFIG.C_ENABLE_ILA_AXI_MON {false} CONFIG.C_MONITOR_TYPE {Native}] [get_bd_cells ila_0]
...
connect_bd_net [get_bd_pins ila_0/probe7] [get_bd_pins axi_dma_0/s_axis_s2mm_tready]

connect_bd_net [get_bd_pins ila_0/probe8] [get_bd_pins prll_bs_gnrtr_n_rbtr_0/push_drvr_0_bus_0]
connect_bd_net [get_bd_pins ila_0/probe9] [get_bd_pins unpackaging_IP_block_0/in_fifo_V_read]
connect_bd_net [get_bd_pins ila_0/probe10] [get_bd_pins packaging_IP_block_0/out_fifo_V_write]

connect_bd_net [get_bd_pins ila_0/probe11] [get_bd_pins prll_bs_gnrtr_n_rbtr_0/pop_drvr_0_bus_0]
connect_bd_net [get_bd_pins ila_0/probe12] [get_bd_pins prll_bs_gnrtr_n_rbtr_0/push_drvr_1_bus_0]
connect_bd_net [get_bd_pins ila_0/probe13] [get_bd_pins prll_bs_gnrtr_n_rbtr_0/pop_drvr_1_bus_0]
