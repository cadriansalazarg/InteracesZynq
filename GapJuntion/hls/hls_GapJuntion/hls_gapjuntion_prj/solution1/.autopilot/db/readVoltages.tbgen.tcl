...
set C_modelName {readVoltages}
set C_modelType { void 0 }
set C_modelArgList {
	{ voltagesBackup float 32 regular {array 10000 { 0 0 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "voltagesBackup", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ voltagesBackup_we0 sc_out sc_logic 1 signal 0 } 
	{ voltagesBackup_d0 sc_out sc_lv 32 signal 0 } 
	{ voltagesBackup_address1 sc_out sc_lv 14 signal 0 } 
	{ voltagesBackup_ce1 sc_out sc_logic 1 signal 0 } 
	{ voltagesBackup_we1 sc_out sc_logic 1 signal 0 } 
	{ voltagesBackup_d1 sc_out sc_lv 32 signal 0 } 
	{ V_SIZE sc_in sc_lv 32 signal 1 } 
	{ V_data_V_data_0_dout sc_in sc_lv 32 signal 2 } 
	{ V_data_V_data_0_empty_n sc_in sc_logic 1 signal 2 } 
	{ V_data_V_data_0_read sc_out sc_logic 1 signal 2 } 
	{ V_data_V_data_1_dout sc_in sc_lv 32 signal 3 } 
	{ V_data_V_data_1_empty_n sc_in sc_logic 1 signal 3 } 
	{ V_data_V_data_1_read sc_out sc_logic 1 signal 3 } 
	{ V_data_V_data_2_dout sc_in sc_lv 32 signal 4 } 
	{ V_data_V_data_2_empty_n sc_in sc_logic 1 signal 4 } 
	{ V_data_V_data_2_read sc_out sc_logic 1 signal 4 } 
	{ V_data_V_data_3_dout sc_in sc_lv 32 signal 5 } 
	{ V_data_V_data_3_empty_n sc_in sc_logic 1 signal 5 } 
	{ V_data_V_data_3_read sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "voltagesBackup_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "voltagesBackup", "role": "we0" }} , 
 	{ "name": "voltagesBackup_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "voltagesBackup", "role": "d0" }} , 
 	...
 	{ "name": "voltagesBackup_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "voltagesBackup", "role": "we1" }} , 
 	{ "name": "voltagesBackup_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "voltagesBackup", "role": "d1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "voltagesBackup", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "7501"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "7501"}
]}
...
set Spec2ImplPortList { 
	voltagesBackup { ap_memory {  { voltagesBackup_address0 mem_address 1 14 }  { voltagesBackup_ce0 mem_ce 1 1 }  { voltagesBackup_we0 mem_we 1 1 }  { voltagesBackup_d0 mem_din 1 32 }  { voltagesBackup_address1 MemPortADDR2 1 14 }  { voltagesBackup_ce1 MemPortCE2 1 1 }  { voltagesBackup_we1 MemPortWE2 1 1 }  { voltagesBackup_d1 MemPortDIN2 1 32 } } }
