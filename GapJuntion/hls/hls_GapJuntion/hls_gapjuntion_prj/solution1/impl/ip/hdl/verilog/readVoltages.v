...
reg  signed [26:0] p_i_reg_123;
wire  signed [63:0] tmp_19_i_fu_164_p1;
wire    ap_CS_fsm_state3;
wire  signed [63:0] tmp_19_1_i_fu_175_p1;
wire  signed [63:0] tmp_19_2_i_fu_186_p1;
wire  signed [63:0] tmp_19_3_i_fu_197_p1;
reg    V_data_V_data_00_update;
wire  signed [31:0] tmp_i_fu_135_p1;
wire  signed [27:0] lhs_V_fu_160_p1;
wire   [27:0] ret_V_i_fu_169_p2;
wire   [26:0] ret_V_1_i_fu_180_p2;
wire   [26:0] ret_V_2_i_fu_191_p2;
reg   [3:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((tmp_11_i_fu_139_p2 == 1'd1) & (1'b0 == V_data_V_data_00_status)) & (tmp_11_i_fu_139_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((tmp_11_i_fu_139_p2 == 1'd1) & (1'b0 == V_data_V_data_00_status)) & (tmp_11_i_fu_139_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((tmp_11_i_fu_139_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((~((tmp_11_i_fu_139_p2 == 1'd1) & (1'b0 == V_data_V_data_00_status)) & (tmp_11_i_fu_139_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        voltagesBackup_address0 = tmp_19_2_i_fu_186_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        voltagesBackup_address0 = tmp_19_i_fu_164_p1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        voltagesBackup_address1 = tmp_19_3_i_fu_197_p1;
    end else if ((1'b1 == ap_CS_fsm_state3)) begin
        voltagesBackup_address1 = tmp_19_1_i_fu_175_p1;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((tmp_11_i_fu_139_p2 == 1'd1) & (1'b0 == V_data_V_data_00_status)) & (tmp_11_i_fu_139_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((tmp_11_i_fu_139_p2 == 1'd1) & (1'b0 == V_data_V_data_00_status)) & (tmp_11_i_fu_139_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = ((tmp_11_i_fu_139_p2 == 1'd1) & (1'b0 == V_data_V_data_00_status));
end

assign i_V_fu_202_p2 = ($signed(p_i_reg_123) + $signed(27'd4));

assign lhs_V_fu_160_p1 = p_i_reg_123;

assign ret_V_1_i_fu_180_p2 = (p_i_reg_123 | 27'd2);

assign ret_V_2_i_fu_191_p2 = (p_i_reg_123 | 27'd3);

assign ret_V_i_fu_169_p2 = (lhs_V_fu_160_p1 | 28'd1);

assign tmp_11_i_fu_139_p2 = (($signed(tmp_i_fu_135_p1) < $signed(V_SIZE)) ? 1'b1 : 1'b0);

assign tmp_19_1_i_fu_175_p1 = $signed(ret_V_i_fu_169_p2);

assign tmp_19_2_i_fu_186_p1 = $signed(ret_V_1_i_fu_180_p2);

assign tmp_19_3_i_fu_197_p1 = $signed(ret_V_2_i_fu_191_p2);

assign tmp_19_i_fu_164_p1 = p_i_reg_123;

assign tmp_i_fu_135_p1 = p_i_reg_123;
