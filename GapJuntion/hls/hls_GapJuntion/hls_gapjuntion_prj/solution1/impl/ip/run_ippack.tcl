...
## Variables
set Top "GapJunctionIP"
set TopNoPrefix "GapJunctionIP"
...
set Interfaces {
    ...
    ap_ctrl {
        type "ap_ctrl"
        ctrl_ports "ap_start ap_done ap_continue ap_idle ap_ready"
        ctype {
            start {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 208 II x}
