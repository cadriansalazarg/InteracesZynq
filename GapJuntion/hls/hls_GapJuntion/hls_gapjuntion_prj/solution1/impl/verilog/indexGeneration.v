...
wire   [27:0] tmp_cast_i_i_18_fu_160_p1;
...
assign tmp_12_i_i_fu_164_p2 = (($signed(tmp_cast_i_i_18_fu_160_p1) < $signed(tmp_cast_i_i_reg_267)) ? 1'b1 : 1'b0);

assign tmp_18_i_i_fu_194_p2 = (($signed(t_V_cast_i_i_fu_190_p1) < $signed(simConfig_BLOCK_NUMB_reg_257)) ? 1'b1 : 1'b0);

assign tmp_cast_i_i_18_fu_160_p1 = tmp_data_0_V_reg_134;
