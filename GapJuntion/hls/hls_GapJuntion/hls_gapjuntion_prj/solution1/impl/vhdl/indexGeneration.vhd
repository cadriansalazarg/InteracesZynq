...
architecture behav of indexGeneration is 
    ...
    signal tmp_cast_i_i_18_fu_160_p1 : STD_LOGIC_VECTOR (27 downto 0);
...
begin
    ...
    tmp_12_i_i_fu_164_p2 <= "1" when (signed(tmp_cast_i_i_18_fu_160_p1) < signed(tmp_cast_i_i_reg_267)) else "0";
    tmp_18_i_i_fu_194_p2 <= "1" when (signed(t_V_cast_i_i_fu_190_p1) < signed(simConfig_BLOCK_NUMB_reg_257)) else "0";
    tmp_cast_i_i_18_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_data_0_V_reg_134),28));
