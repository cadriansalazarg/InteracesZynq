...
architecture behav of V_read is 
    ...
    signal V_read_entry169179_U0_ap_start : STD_LOGIC;
    signal V_read_entry169179_U0_ap_done : STD_LOGIC;
    signal V_read_entry169179_U0_ap_continue : STD_LOGIC;
    signal V_read_entry169179_U0_ap_idle : STD_LOGIC;
    signal V_read_entry169179_U0_ap_ready : STD_LOGIC;
    signal V_read_entry169179_U0_start_out : STD_LOGIC;
    signal V_read_entry169179_U0_start_write : STD_LOGIC;
    signal V_read_entry169179_U0_scalar_simConfig_BLOCK_NUMBERS_V_read : STD_LOGIC;
    signal V_read_entry169179_U0_simConfig_BLOCK_NUMBERS_V_out_din : STD_LOGIC_VECTOR (26 downto 0);
    signal V_read_entry169179_U0_simConfig_BLOCK_NUMBERS_V_out_write : STD_LOGIC;
    signal V_read_entry169179_U0_scalar_simConfig_rowsToSimulate_V_read : STD_LOGIC;
    signal V_read_entry169179_U0_simConfig_rowsToSimulate_V_out_din : STD_LOGIC_VECTOR (26 downto 0);
    signal V_read_entry169179_U0_simConfig_rowsToSimulate_V_out_write : STD_LOGIC;
    signal V_read_entry169179_U0_simConfig_rowBegin_V_read : STD_LOGIC;
    signal V_read_entry169179_U0_simConfig_rowEnd_V_read : STD_LOGIC;
    signal V_read_entry169179_U0_simConfig_rowBegin_V_c_i_din : STD_LOGIC_VECTOR (26 downto 0);
    signal V_read_entry169179_U0_simConfig_rowBegin_V_c_i_write : STD_LOGIC;
    signal V_read_entry169179_U0_simConfig_rowEnd_V_c_i_din : STD_LOGIC_VECTOR (26 downto 0);
    signal V_read_entry169179_U0_simConfig_rowEnd_V_c_i_write : STD_LOGIC;
    signal V_read_entry169179_U0_simConfig_rowsToSimulate_V_c_i_din : STD_LOGIC_VECTOR (26 downto 0);
    signal V_read_entry169179_U0_simConfig_rowsToSimulate_V_c_i_write : STD_LOGIC;
    signal V_read_entry169179_U0_simConfig_BLOCK_NUMBERS_V_c_i_din : STD_LOGIC_VECTOR (26 downto 0);
    signal V_read_entry169179_U0_simConfig_BLOCK_NUMBERS_V_c_i_write : STD_LOGIC;
    signal V_read_entry169179_U0_simConfig_BLOCK_NUMBERS_V_c1_i_din : STD_LOGIC_VECTOR (26 downto 0);
    signal V_read_entry169179_U0_simConfig_BLOCK_NUMBERS_V_c1_i_write : STD_LOGIC;
    ...
    signal ap_sync_reg_V_read_entry169179_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_V_read_entry169179_U0_ap_ready : STD_LOGIC;
    signal V_read_entry169179_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    component V_read_entry169179 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    V_read_entry169179_U0 : component V_read_entry169179
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    simConfig_BLOCK_NUMB_5_U : component fifo_w27_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_V_read_entry169179_U0_ap_ready_assign_proc : process(ap_clk)
    begin
    ...
    V_read_entry169179_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = V_read_entry169179_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                V_read_entry169179_U0_ap_ready_count <= std_logic_vector(unsigned(V_read_entry169179_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = V_read_entry169179_U0_ap_ready))) then 
                V_read_entry169179_U0_ap_ready_count <= std_logic_vector(unsigned(V_read_entry169179_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    V_data_V_data_2_read <= readVoltages_U0_V_data_V_data_2_read;
    V_data_V_data_3_read <= readVoltages_U0_V_data_V_data_3_read;
    V_read_entry169179_U0_ap_continue <= ap_sync_continue;
    V_read_entry169179_U0_ap_start <= (real_start and (ap_sync_reg_V_read_entry169179_U0_ap_ready xor ap_const_logic_1));
    ap_channel_done_voltagesBackup <= readVoltages_U0_ap_done;
    ap_done <= ap_sync_done;
    ap_idle <= (writeV2calc_U0_ap_idle and readVoltages_U0_ap_idle and indexGeneration_U0_ap_idle and (voltagesBackup_t_empty_n xor ap_const_logic_1) and V_read_entry169179_U0_ap_idle);
    ap_ready <= internal_ap_ready;
    ap_sync_V_read_entry169179_U0_ap_ready <= (ap_sync_reg_V_read_entry169179_U0_ap_ready or V_read_entry169179_U0_ap_ready);
    ap_sync_continue <= (ap_sync_done and ap_continue);
    ap_sync_done <= (writeV2calc_U0_ap_done and V_read_entry169179_U0_ap_done);
    ap_sync_readVoltages_U0_ap_ready <= (readVoltages_U0_ap_ready or ap_sync_reg_readVoltages_U0_ap_ready);
    ap_sync_ready <= (ap_sync_readVoltages_U0_ap_ready and ap_sync_V_read_entry169179_U0_ap_ready);
    fixedData_V_data_din <= writeV2calc_U0_fixedData_V_data_din;
    fixedData_V_data_write <= writeV2calc_U0_fixedData_V_data_write;
    fixedData_V_tlast_V_din <= writeV2calc_U0_fixedData_V_tlast_V_din;
    fixedData_V_tlast_V_write <= writeV2calc_U0_fixedData_V_tlast_V_write;
    ...
    simConfig_BLOCK_NUMBERS_V_out_din <= V_read_entry169179_U0_simConfig_BLOCK_NUMBERS_V_out_din;
    simConfig_BLOCK_NUMBERS_V_out_write <= V_read_entry169179_U0_simConfig_BLOCK_NUMBERS_V_out_write;
    simConfig_BLOCK_NUMBERS_V_read <= V_read_entry169179_U0_scalar_simConfig_BLOCK_NUMBERS_V_read;
    simConfig_rowBegin_V_read <= V_read_entry169179_U0_simConfig_rowBegin_V_read;
    simConfig_rowEnd_V_read <= V_read_entry169179_U0_simConfig_rowEnd_V_read;
    simConfig_rowsToSimulate_V_out_din <= V_read_entry169179_U0_simConfig_rowsToSimulate_V_out_din;
    simConfig_rowsToSimulate_V_out_write <= V_read_entry169179_U0_simConfig_rowsToSimulate_V_out_write;
    simConfig_rowsToSimulate_V_read <= V_read_entry169179_U0_scalar_simConfig_rowsToSimulate_V_read;
