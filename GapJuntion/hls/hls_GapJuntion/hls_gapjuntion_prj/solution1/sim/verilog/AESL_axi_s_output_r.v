...
`define TV_OUT_output_r_TDATA "../tv/rtldatafile/rtl.GapJunctionIP.autotvout_output_V_data.dat"
`define TV_OUT_output_r_TLAST "../tv/rtldatafile/rtl.GapJunctionIP.autotvout_output_V_tlast_V.dat"
...
module AESL_axi_s_output_r (
    ...
    fifo #(96, 32) fifo_output_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_output_r_TREADY = ~(output_r_TDATA_full || output_r_TLAST_full);
