...
if {[file isfile GapJunctionIP.autotvin.dat]} {
	file delete -force GapJunctionIP.autotvin.dat
}

if {[file isfile GapJunctionIP.autotvout.dat]} {
	file delete -force GapJunctionIP.autotvout.dat
}
