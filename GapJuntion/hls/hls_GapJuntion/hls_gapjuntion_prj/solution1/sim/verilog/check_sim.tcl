# ==============================================================
# File generated on Sat May 15 00:04:19 CST 2021
...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.GapJunctionIP.autotvin_input_V_data.dat"
         "c.GapJunctionIP.autotvin_output_V_data.dat"
         "c.GapJunctionIP.autotvin_output_V_tlast_V.dat"
         "c.GapJunctionIP.autotvin_size.dat"
         "c.GapJunctionIP.autotvin_FirstRow.dat"
         "c.GapJunctionIP.autotvin_LastRow.dat"
         "c.GapJunctionIP.autotvout_output_V_data.dat"
         "c.GapJunctionIP.autotvout_output_V_tlast_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.GapJunctionIP.autotvout_output_V_data.dat"
         "rtl.GapJunctionIP.autotvout_output_V_tlast_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
