...
indexGeneration::indexGeneration(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( Vi_idx_V_data_V_01_status );
    sensitive << ( tmp_cast_i_i_18_fu_160_p1 );
    ...
    SC_METHOD(thread_tmp_cast_i_i_18_fu_160_p1);
    sensitive << ( tmp_data_0_V_reg_134 );
    ...
    sc_trace(mVcdFile, tmp_cast_i_i_18_fu_160_p1, "tmp_cast_i_i_18_fu_160_p1");
...
void indexGeneration::thread_tmp_12_i_i_fu_164_p2() {
    tmp_12_i_i_fu_164_p2 = (!tmp_cast_i_i_18_fu_160_p1.read().is_01() || !tmp_cast_i_i_reg_267.read().is_01())? sc_lv<1>(): (sc_bigint<28>(tmp_cast_i_i_18_fu_160_p1.read()) < sc_bigint<28>(tmp_cast_i_i_reg_267.read()));
}
...
void indexGeneration::thread_tmp_cast_i_i_18_fu_160_p1() {
    tmp_cast_i_i_18_fu_160_p1 = esl_zext<28,27>(tmp_data_0_V_reg_134.read());
}
