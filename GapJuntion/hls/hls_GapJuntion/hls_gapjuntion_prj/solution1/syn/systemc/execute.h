...
struct execute : public sc_module {
    ...
    sc_signal< sc_logic > blockControl173_U0_ap_start;
    sc_signal< sc_logic > blockControl173_U0_ap_done;
    sc_signal< sc_logic > blockControl173_U0_ap_continue;
    sc_signal< sc_logic > blockControl173_U0_ap_idle;
    sc_signal< sc_logic > blockControl173_U0_ap_ready;
    sc_signal< sc_logic > blockControl173_U0_start_out;
    sc_signal< sc_logic > blockControl173_U0_start_write;
    sc_signal< sc_logic > blockControl173_U0_input_V_data_TREADY;
    sc_signal< sc_lv<27> > blockControl173_U0_simConfig_rowBegin_V_out_din;
    sc_signal< sc_logic > blockControl173_U0_simConfig_rowBegin_V_out_write;
    sc_signal< sc_lv<27> > blockControl173_U0_simConfig_rowEnd_V_out_din;
    sc_signal< sc_logic > blockControl173_U0_simConfig_rowEnd_V_out_write;
    sc_signal< sc_lv<27> > blockControl173_U0_simConfig_rowsToSimulate_V_out_din;
    sc_signal< sc_logic > blockControl173_U0_simConfig_rowsToSimulate_V_out_write;
    sc_signal< sc_lv<27> > blockControl173_U0_simConfig_BLOCK_NUMBERS_V_out_din;
    sc_signal< sc_logic > blockControl173_U0_simConfig_BLOCK_NUMBERS_V_out_write;
    sc_signal< sc_lv<32> > blockControl173_U0_V_data_V_data_0_din;
    sc_signal< sc_logic > blockControl173_U0_V_data_V_data_0_write;
    sc_signal< sc_lv<32> > blockControl173_U0_V_data_V_data_1_din;
    sc_signal< sc_logic > blockControl173_U0_V_data_V_data_1_write;
    sc_signal< sc_lv<32> > blockControl173_U0_V_data_V_data_2_din;
    sc_signal< sc_logic > blockControl173_U0_V_data_V_data_2_write;
    sc_signal< sc_lv<32> > blockControl173_U0_V_data_V_data_3_din;
    sc_signal< sc_logic > blockControl173_U0_V_data_V_data_3_write;
    ...
    sc_signal< sc_logic > calc_U0_start_out;
    ...
    sc_signal< sc_lv<1> > start_for_V_read_U0_din;
    sc_signal< sc_logic > start_for_V_read_U0_full_n;
    sc_signal< sc_lv<1> > start_for_V_read_U0_dout;
    sc_signal< sc_logic > start_for_V_read_U0_empty_n;
    ...
    void thread_blockControl173_U0_ap_continue();
    void thread_blockControl173_U0_ap_start();
    ...
    void thread_start_for_V_read_U0_din();
