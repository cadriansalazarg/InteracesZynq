...
readVoltages::readVoltages(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_ret_V_1_i_fu_180_p2);
    sensitive << ( p_i_reg_123 );

    SC_METHOD(thread_ret_V_2_i_fu_191_p2);
    sensitive << ( p_i_reg_123 );

    SC_METHOD(thread_ret_V_i_fu_169_p2);
    sensitive << ( lhs_V_fu_160_p1 );

    SC_METHOD(thread_tmp_11_i_fu_139_p2);
    sensitive << ( V_SIZE );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( tmp_11_i_fu_139_p2 );
    sensitive << ( V_data_V_data_00_status );
    sensitive << ( tmp_i_fu_135_p1 );

    SC_METHOD(thread_tmp_19_1_i_fu_175_p1);
    sensitive << ( ret_V_i_fu_169_p2 );

    SC_METHOD(thread_tmp_19_2_i_fu_186_p1);
    sensitive << ( ret_V_1_i_fu_180_p2 );

    SC_METHOD(thread_tmp_19_3_i_fu_197_p1);
    sensitive << ( ret_V_2_i_fu_191_p2 );

    SC_METHOD(thread_tmp_19_i_fu_164_p1);
    sensitive << ( p_i_reg_123 );

    SC_METHOD(thread_tmp_i_fu_135_p1);
    sensitive << ( p_i_reg_123 );

    SC_METHOD(thread_voltagesBackup_address0);
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( tmp_19_i_fu_164_p1 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( tmp_19_2_i_fu_186_p1 );

    SC_METHOD(thread_voltagesBackup_address1);
    sensitive << ( ap_CS_fsm_state4 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( tmp_19_1_i_fu_175_p1 );
    sensitive << ( tmp_19_3_i_fu_197_p1 );
    ...
    sc_trace(mVcdFile, tmp_11_i_fu_139_p2, "tmp_11_i_fu_139_p2");
    ...
    sc_trace(mVcdFile, tmp_19_i_fu_164_p1, "tmp_19_i_fu_164_p1");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, tmp_19_1_i_fu_175_p1, "tmp_19_1_i_fu_175_p1");
    sc_trace(mVcdFile, tmp_19_2_i_fu_186_p1, "tmp_19_2_i_fu_186_p1");
    sc_trace(mVcdFile, tmp_19_3_i_fu_197_p1, "tmp_19_3_i_fu_197_p1");
    sc_trace(mVcdFile, V_data_V_data_00_update, "V_data_V_data_00_update");
    sc_trace(mVcdFile, tmp_i_fu_135_p1, "tmp_i_fu_135_p1");
    sc_trace(mVcdFile, lhs_V_fu_160_p1, "lhs_V_fu_160_p1");
    sc_trace(mVcdFile, ret_V_i_fu_169_p2, "ret_V_i_fu_169_p2");
    sc_trace(mVcdFile, ret_V_1_i_fu_180_p2, "ret_V_1_i_fu_180_p2");
    sc_trace(mVcdFile, ret_V_2_i_fu_191_p2, "ret_V_2_i_fu_191_p2");
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    !(esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_0, V_data_V_data_00_status.read())) && 
                    esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_0))) {
            ap_done_reg = ap_const_logic_1;
        }
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        p_i_reg_123 = i_V_fu_202_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
        p_i_reg_123 = ap_const_lv27_0;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_1) && !(esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_0, V_data_V_data_00_status.read())))) {
...
void readVoltages::thread_V_data_V_data_00_update() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
         esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_1) && 
         !(esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_0, V_data_V_data_00_status.read())))) {
...
void readVoltages::thread_ap_block_state2() {
    ap_block_state2 = (esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_0, V_data_V_data_00_status.read()));
}
...
void readVoltages::thread_i_V_fu_202_p2() {
    i_V_fu_202_p2 = (!p_i_reg_123.read().is_01() || !ap_const_lv27_4.is_01())? sc_lv<27>(): (sc_bigint<27>(p_i_reg_123.read()) + sc_biguint<27>(ap_const_lv27_4));
}

void readVoltages::thread_lhs_V_fu_160_p1() {
    lhs_V_fu_160_p1 = esl_sext<28,27>(p_i_reg_123.read());
}

void readVoltages::thread_ret_V_1_i_fu_180_p2() {
    ret_V_1_i_fu_180_p2 = (p_i_reg_123.read() | ap_const_lv27_2);
}

void readVoltages::thread_ret_V_2_i_fu_191_p2() {
    ret_V_2_i_fu_191_p2 = (p_i_reg_123.read() | ap_const_lv27_3);
}

void readVoltages::thread_ret_V_i_fu_169_p2() {
    ret_V_i_fu_169_p2 = (lhs_V_fu_160_p1.read() | ap_const_lv28_1);
}

void readVoltages::thread_tmp_11_i_fu_139_p2() {
    tmp_11_i_fu_139_p2 = (!tmp_i_fu_135_p1.read().is_01() || !V_SIZE.read().is_01())? sc_lv<1>(): (sc_bigint<32>(tmp_i_fu_135_p1.read()) < sc_bigint<32>(V_SIZE.read()));
}

void readVoltages::thread_tmp_19_1_i_fu_175_p1() {
    tmp_19_1_i_fu_175_p1 = esl_sext<64,28>(ret_V_i_fu_169_p2.read());
}

void readVoltages::thread_tmp_19_2_i_fu_186_p1() {
    tmp_19_2_i_fu_186_p1 = esl_sext<64,27>(ret_V_1_i_fu_180_p2.read());
}

void readVoltages::thread_tmp_19_3_i_fu_197_p1() {
    tmp_19_3_i_fu_197_p1 = esl_sext<64,27>(ret_V_2_i_fu_191_p2.read());
}

void readVoltages::thread_tmp_19_i_fu_164_p1() {
    tmp_19_i_fu_164_p1 = esl_sext<64,27>(p_i_reg_123.read());
}

void readVoltages::thread_tmp_i_fu_135_p1() {
    tmp_i_fu_135_p1 = esl_sext<32,27>(p_i_reg_123.read());
}

void readVoltages::thread_voltagesBackup_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        voltagesBackup_address0 =  (sc_lv<14>) (tmp_19_2_i_fu_186_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        voltagesBackup_address0 =  (sc_lv<14>) (tmp_19_i_fu_164_p1.read());
    } else {
...
void readVoltages::thread_voltagesBackup_address1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        voltagesBackup_address1 =  (sc_lv<14>) (tmp_19_3_i_fu_197_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        voltagesBackup_address1 =  (sc_lv<14>) (tmp_19_1_i_fu_175_p1.read());
    } else {
...
void readVoltages::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && !(esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_0, V_data_V_data_00_status.read())) && esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_0))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_1) && !(esl_seteq<1,1,1>(tmp_11_i_fu_139_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_0, V_data_V_data_00_status.read())))) {
