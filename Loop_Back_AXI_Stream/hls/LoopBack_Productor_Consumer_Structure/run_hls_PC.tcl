...
set_top loopback
add_files loopback_PC.cpp -cflags "-std=c++11 -Wno-unknown-pragmas" 
add_files -tb loopback_PC_tb.cpp -cflags "-std=c++11 -Wno-unknown-pragmas" 

# Solution1 *************************
open_solution -reset "solution1"
set_part  {xc7z020clg484-1} 
create_clock -period 10 -name default  
source "directives_PC.tcl"
