...
#define SIZE 2048 // Como el tamaño está alambrado en hardware, debe asegurarse que está variable coincida con el valor de SIZE seleccionado en el HLS cuando se creo el IP
