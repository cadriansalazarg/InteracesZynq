...
connect_bd_net [get_bd_pins loopback_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0]
connect_bd_net [get_bd_pins loopback_0/ap_rst_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
...
# Por defecto aparecen dos puertos, pero como se tienen dos interrupciones del DMA más una interrupción 
# del timer, entonces se extiende el número de puertos a 3 del bloque concat 
...
# Se agrega un bloque de una constante con un valor igual a 1, para conectar a un valor lógico q, el puerto ap_start

startgroup
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_0
endgroup

connect_bd_net [get_bd_pins xlconstant_0/dout] [get_bd_pins loopback_0/ap_start]
connect_bd_net [get_bd_pins loopback_0/ap_continue] [get_bd_pins loopback_0/ap_ready]
