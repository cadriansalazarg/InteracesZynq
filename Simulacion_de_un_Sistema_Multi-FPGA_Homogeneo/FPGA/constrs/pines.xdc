...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {RST}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {A}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {B}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {Cin}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {S}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {Cout}];  # "JA7"
