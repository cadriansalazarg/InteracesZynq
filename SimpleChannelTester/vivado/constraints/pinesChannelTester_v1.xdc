...
#set_property PACKAGE_PIN W21 [get_ports channel_up_1]
#set_property IOSTANDARD LVCMOS25 [get_ports channel_up_1]
...
create_clock -name clk_200MHz_p -period 5.0 [get_ports clk_200MHz_p]
