...
exec rm -rf SimpleChannelTester_v2/ vivado.*

# Se crea el proyecto
create_project SimpleChannelTester_v2 SimpleChannelTester_v2 -part xc7z045ffg900-2
...
# Se elimina el clock out 3 de 200MHz, esta línea debe ser comentada en caso de que se pretenda usar el ILA
startgroup
...
# Se configura el reloj del Zynq para el PL, el valor mínimo es 50 y el máximo 250
startgroup
...
# Se crea un p# Reset del sistema
...
connect_bd_net [get_bd_pins rst_ps7_0_100M/peripheral_reset] [get_bd_pins prll_bs_gnrtr_n_rbtr_0/reset]
connect_bd_net [get_bd_pins rst_ps7_0_100M/peripheral_reset] [get_bd_pins Aurora_init_0/RST]
...
connect_bd_net [get_bd_pins rst_ps7_0_100M/peripheral_reset] [get_bd_pins fifo_generator_0/rst]
connect_bd_net [get_bd_pins rst_ps7_0_100M/peripheral_reset] [get_bd_pins fifo_generator_1/rst]

# Se invierte el reset para conectarlo a la unidad de empaquetamiento y desempaquetamiento
connect_bd_net [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]  [get_bd_pins packaging_IP_block_0/ap_rst_n]
connect_bd_net [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]  [get_bd_pins unpackaging_IP_block_0/ap_rst_n]
