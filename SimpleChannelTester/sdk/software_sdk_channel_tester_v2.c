...
#define MAX_PKT_LEN_TX		0xD9  // Number of u32 data to be transmitted (2048 elementos de tipo u32)

#define MAX_PKT_LEN_IN_BYTES_TX	MAX_PKT_LEN_TX*4  //Total de bytes por transferencia, en este caso, como el tipo de dato es u32, se multiplica por 4 para sacar el número de bytes (2048 por 4)
...
#define TEST_START_VALUE	0x00000001  //Todos los datos que se transfieren tienen este valor
...
int XAxiDma_SimplePollExample(u16 DeviceId)
{
	 ...
	 * is enabled
	 */
	Xil_DCacheFlushRange((UINTPTR)TxBufferPtr, MAX_PKT_LEN_IN_BYTES_TX);
	...
	for(Index = 0; Index < Tries; Index ++) {
		...
		Status = XAxiDma_SimpleTransfer(&AxiDma,(UINTPTR) TxBufferPtr,
				MAX_PKT_LEN_IN_BYTES_TX, XAXIDMA_DMA_TO_DEVICE);
